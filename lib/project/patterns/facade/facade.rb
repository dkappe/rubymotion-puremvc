...
module PureMVC
  class Facade
    ...
    def initialize_controller
      ...
      @controller = PureMVC::Controller.instance
    end
    ...
    def send_notification(notification_name, body=nil, type=nil)
      notify_observers(PureMVC::Notification.new(notification_name, body, type))
    end
